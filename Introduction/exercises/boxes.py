...
def min_count(product_count, box_size):
    ...
    # special case of floor division you can actually trick python to giving ceil using the negative operand on both the outside and inside
    # I imagine there is another way to solve this will check again another time
